...
// <<< הוספה: קבוע שמגדיר את גובה הניווט. שנה לפי הצורך >>>
const NAVBAR_HEIGHT = 65; // הערכה לגובה הניווט בפיקסלים
...
export default function VolunteerMap() {
  ...
  // <<< הוספה: State חדש לשליטה על נראות הפאנל >>>
  ...
  // ... כל פונקציות העזר וה-useEffect שלך נשארים כאן ללא שינוי ...
  // (extractCoordinates, fetchInquiries, useEffects, assignToInquiry, etc.)
              ...
              <Marker
                ...
                eventHandlers={{
                  click: () => {
                    ...
                    setSelectedVolunteerIds([]);
                    // <<< שינוי: פותח את הפאנל אוטומטית בלחיצה >>>
